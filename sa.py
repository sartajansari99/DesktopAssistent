...
def wishMe():
    weather_api = "006a8e99145842acbce33809232910"
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('sartaansari121sa@gmail.com', 'uusg fnih iooq dlqf')
    server.sendmail('sartajansari7808@gmail.com', to, content)
    server.close()
...
def TaskExecution():
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            news_api = "e1452ad0bc45445daac8cb890ac92b95"
           ...
           api_key = "d8a526ce1a5b58e696b0051f7ac7e0d0314153058b8cac4d2bb9d596c31e5f74"
           speak("Playing sir")
           ...
           os.startfile(take2)           
            ...
            #get api key from https://serpapi.com
            api_key = "6540a369eb690f7848ab8243"
            ...
            while True:
                ...
                if 'back' in query:
                    ...
                    url = f"https://serpapi.com/searches/4ee411154dd3db96/6540a369eb690f7848ab8243.json"
                    result = requests.get(url).text
                    loadit = json.loads(result)
            ...
            speak("Opening Sir")
            path = r"https://mail.google.com/mail/u/0/#inbox"
            os.startfile(path)
            ...
            speak("Opening Sir")
            path = r"C:\Users\sarta\AppData\Local\Programs\Microsoft VS Code\Code.exe"
            os.startfile(path)
            ...
            path = r"https://www.instagram.com/"
            os.startfile(path)
        ...
        elif 'i want to see note' in query:
            speak("Showing note...")
            ...
            speak("I am created by sartaj, who is an awesome guy")
        ...
        elif 'email to sartaj' in query:
            try:
                speak("What should I say?")
                content = takeCommand()
                to = "sartaansari121sa@gmail.com"    
        ...
        elif 'good bye' in command or 'exit' in command or 'quit' in command:
